                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            ...
                            @php
                                ...
                                $date04 = \Carbon\Carbon::parse($above->first()->above_date);
                                ...
                                $dayThai04 = $date03->format('j'); // วันที่ (ไม่ใช่เลขไทย)
                ...
                <div class="pl-[4rem] pr-[2rem]">
                    <div class="border p-2">
                        ...
                        @foreach ($comment_choice as $comment)
                            <div class="pl-[4rem]">
                                <input type="radio" name="above_comment_num" value="{{ $comment->id }}"
                                    ...
                                    {{ $above->first()->above_comment_num == $comment->id ? 'checked' : '' }}>
                        ...
                        <div class="flex justify-between pl-[4rem]">
                            <div id="textarea-container"
                                style="display: {{ $above->first()->above_comment_num == 2 ? 'block' : 'none' }};">
                                <span>ดังนี้</span><br>
                                <textarea class="bg-blue-100 rounded pl-2 p-1 mb-2 w-[25rem] h-[6rem]" id="comment-textarea"> {{ $above->first()->above_comment_detail }} </textarea>
                            </div>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    // ตั้งค่าให้ textarea แสดงเมื่อโหลดหน้า ถ้าค่าที่เลือกคือ 2
                                    var selectedRadio = document.querySelector('input[name="above_comment_num"]:checked');
                            ...
                            <div class="">
                                <div class="flex gap-4 items-center">
                                    <span>ลงชื่อ</span>
                                    <img class="w-[8rem] h-[3rem]"
                                        src="/storage/{{ $above->first()->above_signature }}" alt="">
                                </div>
                                <h1 class="text-center">({{ $above->first()->above->name }})</h1 class="text-center">
                                <div class="flex gap-2">
                                    <h1>ตำเเหน่ง</h1>
                                    <span>{{ $above->first()->above->JobPosition->job_position_name }}{{ $above->first()->above->Tier->tier_name }}</span>
                                </div>
                                <label>วันที่</label>
                    ...
                    <div class="pl-[4rem] pr-[2rem]">
                        <div class="border-r border-l border-b p-2">
                            ...
                            @endforeach
                            <div class="flex justify-between pl-[4rem]">
                                <div id="textarea-container02" style="display: none;">
                                    <span>ดังนี้</span><br>
                                    <textarea name="further_comment_detail" class="bg-blue-100 rounded pl-2 p-1 mb-2 w-[25rem] h-[6rem]"
                                ...
                                <div>
                                    <div x-data="{
                                        ...
                                        <div class="flex gap-2 items-center mt-2">
                                            ...
                                            <button type="button" @click="showSignaturePad = true"
                                                id="add_signature" class="p-1 bg-blue-500 text-white text-sm rounded">
                                                เพิ่มลายเซ็น
                                            </button>
                                        </div>
                                    ...
                                    <label>วันที่</label>
                                    <input type="date" name="further_date" class="bg-blue-100 rounded pl-2 p-1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-[4rem] pr-[2rem] mb-[2rem] mt-[2rem]">
                            ...
                            <h1><span>ส่วนที่ ๒</span> สรุปผลการประเมิน
                                ใช้กรอกค่าคะเเนนการประเมินในองค์ประกอบด้านสัมฤทธิ์ของงาน
                            ...
                            <h1><span>ส่วนที่ ๔</span> การรับทราบผลการประเมิน ผู้รับการประเมินลงนามรับทราบผลการประเมิน
                            </h1>
