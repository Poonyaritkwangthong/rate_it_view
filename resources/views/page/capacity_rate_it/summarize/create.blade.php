...
<body>
    <div class="w-[80rem] h-full border mx-auto">
        <form action="{{ route('page.capacity_rate_it.summarize.store') }}"  method="POST"   enctype="multipart/form-data">
                ...
                <div x-data="{
                    ...
                    <table class="border w-full">
                        ...
                        <tbody>
                            <template x-for="(row, index) in rows" :key="index">
                                <tr class="border-t">
                                    <td class="border-r">
                                        <input type="text" name="skill_to_dev[]" class="pl-2 p-1 w-full"
                                            x-model="row.skill">
                                    </td>
                                    <td class="border-r">
                                        <input type="text" name="dev_method[]" class="pl-2 p-1 w-full"
                                            x-model="row.method">
                                    </td>
                                    <td class="border-r">
                                        <input type="text" name="dev_time[]" class="pl-2 p-1 w-full"
                                            x-model="row.time">
                                    </td>
                                    <td class="text-center bg-red-500">
                                        <button type="button" @click="removeRow(index)"
                                            class="w-[5rem] h-[2rem] text-white text-sm">
                                            ลบ
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <div class="flex justify-end pr-3">
                        <button type="button" @click="addRow()"
                            class="mt-2 p-1 bg-green-500 text-white rounded text-sm">
                            เพิ่มแถว
                        </button>
                    </div>
                </div>
                ...
                <div class="border p-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            ...
                            <label>วันที่</label>
                            <input type="date" name="personal_date" class="bg-blue-100 rounded pl-2 p-1">
                        </div>
                    </div>
                </div>
                <div class="border-r border-l border-b">
                    <div class="p-2">
                        <h1>ผู้ประเมิน</h1>
                        ...
                        <div class="flex gap-2 ">
                            <div>
                                ...
                                <input type="date" name="on_the_date" class="bg-blue-100 rounded pl-2 p-1 ">  --}}
                            </div>
                            ...
                            <div>
                                    ...
                                    <div x-data="{
                                        ...
                                        <div class="flex gap-2 items-center mt-2">
                                            <template x-if="signatureUrl2">
                                                <img :src="signatureUrl2" alt="ลายเซ็น"
                                                    class="w-32 h-10 border p-1">
                                            </template>
                                            <button type="button" @click="showSignaturePad2 = true"
                                                id="add_signature2"
                                                class="p-1 bg-blue-500 text-white text-sm rounded">
                                                เพิ่มลายเซ็น
                                            </button>
                                        ...
                                        <input type="hidden" name="evaluator_signature" x-model="signatureUrl2">
                                        <!-- Modal สำหรับ Signature Pad -->
                                            ...
                                            <div class="bg-white p-5 rounded-lg shadow-lg w-96">
                                                ...
                                                <div class="flex justify-between mt-3">
                                                    <button type="button" id="clear2"
                                                        class="px-3 py-1 bg-gray-300 rounded">ล้างลายเซ็น</button>
                                                    <button type="button" @click="saveSignature2()"
                                                        class="px-3 py-1 bg-green-500 text-white rounded">บันทึก</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="">
                                    ...
                                    <label>วันที่</label>
                                    <input type="date" name="evaluation_date" class="bg-blue-100 rounded pl-2 p-1 mb-2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between border-t p-2">
                        <div class="">
                            ...
                            <label>โดยมี</label>
                            <input type="text" name="witness_num" class="bg-blue-100 rounded pl-2 p-1">
                            <label>เป็นพยาน</label>
                        </div>
                    </div>
                    <div class="ml-[10rem]">
                        <label>ลงชื่อ</label>
                        <input type="text" name="witness_singature" class="bg-blue-100 rounded pl-2 p-1 mb-2">
                        <label>พยาน</label><br>
                        <label>ตำเเหน่ง</label>
                        <input type="text" name="" class="bg-blue-100 rounded pl-2 p-1 mb-2"><br>
                        <label>วันที่</label>
                        <input type="date" name="witness_date" class="bg-blue-100 rounded pl-2 p-1 mb-2">
                    </div>
                </div>
            </div>
            ...
            <div class="pl-[4rem] pr-[2rem] mt-6 mb-6">
                <h1>คำชี้เเจง</h1>
